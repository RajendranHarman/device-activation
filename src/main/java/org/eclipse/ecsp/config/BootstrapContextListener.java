...
public class BootstrapContextListener implements ServletContextListener {
     ...
     * Sets the application configuration location based on the servlet context path.
     *
     * @param sce The ServletContextEvent object containing the event details.
     */
    @Override
     ...
     * @throws ApiResourceNotFoundException If unable to initialize configuration for the web application context.
     */
