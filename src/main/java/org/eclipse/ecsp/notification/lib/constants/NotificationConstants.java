...
/**
 * The {@code NotificationConstants} class contains constant values used in the notification library.
 * These constants define URLs, default values, and header names used in the library.
 */
