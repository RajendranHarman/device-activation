...
public class HcpServicesConfig {
    ...
    /**
     * Configures and returns a RestTemplate instance.
     *
    ...
    /**
     * Configures and returns a RestTemplate instance for PATCH specific APIs.
     *
     * @return the configured RestTemplate instance for PATCH requests
     */
    @Bean
