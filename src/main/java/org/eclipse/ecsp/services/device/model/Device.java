...
public class Device {
    ...
    public Device(String harmanId, Timestamp activationDate, String passcode, long randomNumber) {
        ...
        this.activationDate = activationDate != null ? (Timestamp) activationDate.clone() : null;
    ...
    public Timestamp getActivationDate() {
        return activationDate != null ? (Timestamp) activationDate.clone() : null;
    }
    ...
    public String toString() {
        return "Device{"
            ...
            + ", registeredScopeId='" + registeredScopeId + '\''
            + '}';
    }
}
