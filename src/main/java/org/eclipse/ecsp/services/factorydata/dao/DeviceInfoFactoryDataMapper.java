...
/**
 * The DeviceInfoFactoryDataMapper class is responsible for mapping the result set
 * from the database to the DeviceInfoFactoryData object.
 */
public class DeviceInfoFactoryDataMapper implements RowMapper<DeviceInfoFactoryData> {
    ...
    /**
     * Maps a row from the result set to a DeviceInfoFactoryData object.
     *
     * @param resultSet The result set containing the data from the database.
