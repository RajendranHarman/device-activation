...
public class DeviceActivationState {
    ...
    /**
     * Retrieves the unique identifier of the device activation state.
     *
    ...
    /**
     * Sets the unique identifier of the device activation state.
     *
    ...
    /**
     * Retrieves the factory data identifier of the device.
     *
     * @return the factory data identifier of the device
     */
    ...
    /**
     * Sets the factory data identifier of the device.
     *
     * @param factoryDataId the factory data identifier to set
     */
    ...
    public Timestamp getActivationInitiatedOn() {
        activationInitiatedOn = activationInitiatedOn != null ? (Timestamp) activationInitiatedOn.clone() : null;
    ...
    public void setActivationInitiatedOn(Timestamp activationInitiatedOn) {
        this.activationInitiatedOn = activationInitiatedOn != null ? (Timestamp) activationInitiatedOn.clone() : null;
    }
    ...
    public Timestamp getDeactivationInitiatedOn() {
        return deactivationInitiatedOn != null ? (Timestamp) deactivationInitiatedOn.clone() : null;
    }
    ...
    public void setDeactivationInitiatedOn(Timestamp deactivationInitiatedOn) {
        this.deactivationInitiatedOn =
            deactivationInitiatedOn != null ? (Timestamp) deactivationInitiatedOn.clone() : null;
    }
