...
public class TransactionManagerConfig implements TransactionManagementConfigurer {
    ...
    /**
     * Constructs a new TransactionManagerConfig with the specified data source.
     *
    ...
    /**
     * Creates a new instance of the platform transaction manager.
     *
    ...
    /**
     * Retrieves the transaction manager to be used for annotation-driven transaction management.
     *
