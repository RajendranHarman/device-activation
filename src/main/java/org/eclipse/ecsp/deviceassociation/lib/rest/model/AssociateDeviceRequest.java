...
public class AssociateDeviceRequest {
    ...
    /**
     * Retrieves the IMEI (International Mobile Equipment Identity) of the device.
     *
     * @return the IMEI
     */
    @JsonProperty("imei")
    ...
    /**
     * Retrieves the IMSI (International Mobile Subscriber Identity) of the device.
     *
     * @return the IMSI
     */
    @JsonProperty("imsi")
    ...
    /**
     * Retrieves the SSID (Service Set Identifier) of the device.
     *
     * @return the SSID
     */
    @JsonProperty("ssid")
    ...
    /**
     * Retrieves the MSISDN (Mobile Station International Subscriber Directory Number) of the device.
     *
     * @return the MSISDN
     */
    @JsonProperty("msisdn")
    ...
    /**
     * Retrieves the BSSID (Basic Service Set Identifier) of the device.
     *
     * @return the BSSID
     */
    @JsonProperty("bssid")
    ...
    /**
     * Retrieves the factory ID of the device.
     *
