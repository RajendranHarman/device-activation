...
/**
 * The DateTimeUtils class provides utility methods for working with date and time.
 */
public class DateTimeUtils {
    ...
    /**
     * Converts a timestamp to ISO date format.
     *
     * @param timestamp the timestamp to convert
     * @return the date format of the timestamp in ISO format (yyyy-MM-dd'T'HH:mm:ssZ)
     */
    ...
    /**
     * Calculates the GMT offset in minutes for a given timestamp.
     *
