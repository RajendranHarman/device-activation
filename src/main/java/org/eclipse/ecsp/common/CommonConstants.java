...
public final class CommonConstants {
    ...
    public static final String SPRING_AUTH_SCOPE_VALUE = "SelfManage OAuth2ClientMgmt";
    ...
    public static final String PRE_CONDITION_FAILED = "PreCondition failed";
    public static final String VALIDATION_FAILED = "Validation failed";
    public static final String CONTENT_LOCATION = "Content-Location";
    public static final String ORDER_BY = "ORDER BY";
    public static final String COMMA = ",";
    public static final String UNDERSCORE = "_";
    public static final String INVALID_PRESHAREDKEY = "Invalid-presharedKey";
    public static final String NO_DEVICE_FOUND = "no device found or more than one device found in "
        + "device activation table";
    public static final String SPRING_AUTH_FAILED = "exception in spring auth client";

    /**
     * The `CommonConstants` class contains common constants used in the application.
