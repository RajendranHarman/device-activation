...
public class SessionRequest {
    ...
    private List<Regions> updateRegions;
    ...
    /**
     * Gets the list of update regions.
     *
     * @return The list of update regions.
     */
    @JsonProperty("updateRegions")
    public List<Regions> getUpdateRegions() {
        return updateRegions;
    }

    /**
     * Sets the list of update regions.
     *
     * @param updateRegions The list of update regions to set.
     */
    @JsonProperty("updateRegions")
    public void setUpdateRegions(List<Regions> updateRegions) {
     ...
     *
     * @return The string representation of the SessionRequest object.
     */
    @Override
    public String toString() {
        List<Regions> regions = getUpdateRegions();
        String str = "";
        if (regions != null) {
