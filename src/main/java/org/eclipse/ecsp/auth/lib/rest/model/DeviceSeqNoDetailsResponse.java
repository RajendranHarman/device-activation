...
/**
 * Represents the response containing device sequence number and Harman ID list.
 */
@JsonAutoDetect
public class DeviceSeqNoDetailsResponse {
    ...
    /**
     * Retrieves the list of sequence number and Harman ID mappings.
     *
     * @return The list of sequence number and Harman ID mappings.
     */
    @JsonProperty("deviceSeqNoAndHarmanIdList")
    ...
    /**
     * Sets the list of sequence number and Harman ID mappings.
     *
     * @param seqNoHidMapInfo The list of sequence number and Harman ID mappings.
     */
    @JsonProperty("deviceSeqNoAndHarmanIdList")
