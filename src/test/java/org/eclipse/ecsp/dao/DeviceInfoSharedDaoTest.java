...
public class DeviceInfoSharedDaoTest {
    ...
    private static final String SQL_FOR_DELETE_BY_HARMAN_ID = "delete from public"
        + ".\"DeviceInfo\" where \"HarmanID\"=?";
    private static final String SQL_GET_DEVICE_ATTRIBUTES_TO_UPDATE  = "select name "
        + "from device_info_attr";
    private static final String SQL_FOR_UPDATE_DEVICE_INFO =
    ...
    private static final String SQL_UPDATE_STMT =
        "update public.\"DeviceInfo\" SET \"Value\"=? where \"DeviceInfo\".\"HarmanID\"=? AND "
            + "\"DeviceInfo\".\"Name\"=?";
    ...
    private static final String SQL_FOR_UPDATE_LAST_LOGIN_TIME =
        "select * from public.\"DeviceInfo\" where \"DeviceInfo\".\"HarmanID\"=? AND"
            + " \"DeviceInfo\".\"Name\"='Lastlogintime'";
    ...
    public void updateDeviceInfoInsertTest1() {
        ...
        Mockito.doReturn(strLst).when(jdbcTemplate)
            .query(SQL_FOR_UPDATE_DEVICE_INFO, new Object[]{harmanId, name}, new RowMapper<String>() {
    ...
    public void getOemIdOfDeviceTest() {
        ...
        String hwSerialNum = "hwSerialNumber1";
    ...
    public void updateLastLoginTimeForInsertTest1() {
        ...
        assertEquals(0, jdbcTemplate.update(SQL_INSERT_STMT_FOR_UPDATE_LAST_LOGIN_TIME, new Object[]{harmanId, date}));
    }
    ...
    public void updateLastLoginTimeForInsertTest2() {
        ...
        Mockito.doReturn(1).when(jdbcTemplate)
            .update(SQL_INSERT_STMT_FOR_UPDATE_LAST_LOGIN_TIME, new Object[]{harmanId, date});
        deviceInfoSharedDao.updateLastLoginTime(harmanId, date);
        assertEquals(1, jdbcTemplate.update(SQL_INSERT_STMT_FOR_UPDATE_LAST_LOGIN_TIME, new Object[]{harmanId, date}));
    }
    ...
    public void updateLastLoginTimeForUpdateTest1() {
        ...
        deviceInfoSharedDao.updateLastLoginTime(harmanId, date);
        assertEquals(0, jdbcTemplate.update(SQL_UPDATE_STMT_FOR_UPDATE_LAST_LOGIN_TIME, new Object[]{date, harmanId}));
    }
    ...
    public void updateLastLoginTimeUpdateTest2() {
        ...
        Mockito.doReturn(1).when(jdbcTemplate)
            .update(SQL_UPDATE_STMT_FOR_UPDATE_LAST_LOGIN_TIME, new Object[]{date, harmanId});
        deviceInfoSharedDao.updateLastLoginTime(harmanId, date);
        assertEquals(1, jdbcTemplate.update(SQL_UPDATE_STMT_FOR_UPDATE_LAST_LOGIN_TIME, new Object[]{date, harmanId}));
    }
    ...
    public void updateLastLoginTimeMultipleRowsTest() {
        ...
        deviceInfoSharedDao.updateLastLoginTime(harmanId, date);
        assertEquals(strLst,
            jdbcTemplate.query(Mockito.any(), (Object[]) Mockito.any(), (RowMapper<Object>) Mockito.any()));
    }

    @Test
    public void insertFailedTest() {
        final String harmanId = "H1";
